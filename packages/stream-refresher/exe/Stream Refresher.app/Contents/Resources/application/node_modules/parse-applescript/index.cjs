...
class AppleScriptParseError extends Error {
    constructor(message) {
        super(message);
...
class AppleScriptParser {
    ...
    */
    parseData() {
        ...
        const buf = node_buffer.Buffer.alloc(body.length / 2);
        let count = 0;
...
function parseAppleScript(appleScriptString) {
...
exports.AppleScriptParseError = AppleScriptParseError;
exports.parseAppleScript = parseAppleScript;
